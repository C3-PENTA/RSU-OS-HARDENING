...
#define VIDEO_MEM_TOTAL_SIZE		((130 * SZ_1M) - (OVERLAY_MEM_TOTAL_SIZE + SECURED_IN_MEM_SIZE + VIDEO_SBACKUP_MEM_SIZE))//(114*SZ_1M)
#else
#if (TCC_MEM_SIZE > 512)
...
#define TOTAL_FIXED_MEM_SIZE		(PMEM_SURF_SIZE + PMEM_VIQE_SIZE + UMP_RESERVED_SIZE + EXT_CAM_SIZE + FB_MEM_SIZE + OVERLAY_MEM_TOTAL_SIZE + VIDEO_MEM_TOTAL_SIZE + FB_SCALE_MEM_TOTAL_SIZE + VIDEO_DUAL_DISPLAY_SIZE + FB_WMIXER_MEM_SIZE + RAM_CONSOLE_SIZE + OUTPUT_ATTACH_MEM_SIZE + JPEG_ENC_CAPTURE_SIZE + JPEG_RAW_CAPTURE_SIZE + VIDEO_MEM_EXT_SIZE + SECURED_IN_MEM_SIZE + VIDEO_SBACKUP_MEM_SIZE + VIDEO_THUMB_MEM_SIZE + IMAGE_RESTORE_SIZE + FB_WMIXER_MEM_SIZE)
