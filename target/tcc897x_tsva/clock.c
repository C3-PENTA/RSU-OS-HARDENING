...
void clock_init(void)
{
    ...
    //rt5028_set_voltage(RT5028_ID_BUCK1, 1025);    // PWRCORE //set core voltage when sdram is initialized. 
                                                                                                             
    rt5028_set_voltage(RT5028_ID_BUCK2, 1575);  // PWRMEM                                                       
	//rt5028_set_voltage(RT5028_ID_BUCK2, 1550);  // PWRMEM                                                       
    //rt5028_set_voltage(RT5028_ID_BUCK3, 1150);  // PWRCPU                                                    
	rt5028_set_voltage(RT5028_ID_BUCK3, 1175);  // PWRCPU                                                    
	//rt5028_set_voltage(RT5028_ID_BUCK4, 1050);  // PWRGB                  
	rt5028_set_voltage(RT5028_ID_BUCK4, 1075);  // PWRGB  ////170525 by TIMS  ?                
/*                                                                                                             
    rt5028_set_voltage(RT5028_ID_LDO1, 3300);                                                
    rt5028_set_voltage(RT5028_ID_LDO2, 1800);                                        
    rt5028_set_voltage(RT5028_ID_LDO3, 3300);                                             
    rt5028_set_voltage(RT5028_ID_LDO4, 3300);                                              
    rt5028_set_voltage(RT5028_ID_LDO5, 3300);                                                   
    rt5028_set_voltage(RT5028_ID_LDO6, 3300);                                                    
    rt5028_set_voltage(RT5028_ID_LDO7, 1800);                                                 
    rt5028_set_voltage(RT5028_ID_LDO8, 3300);     
*/
#endif
